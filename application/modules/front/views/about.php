                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="ast_testimonials_slider_box">
                                <img src="<?php echo base_url('asset/front/images/content/tm2.jpg')?>" alt="Testimonial">
                        ...
                        <div class="item">
                            <div class="ast_testimonials_slider_box">
                                <img src="<?php echo base_url('asset/front/images/content/tm1.jpg')?>" alt="Testimonial">
                                <div class="ast_testimonials_slider_box_text">
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or less normal distribution.</p>
                        ...
                        <div class="item">
                            <div class="ast_testimonials_slider_box">
                                <img src="<?php echo base_url('asset/front/images/content/tm3.jpg')?>" alt="Testimonial">
                                <div class="ast_testimonials_slider_box_text">
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or less normal distribution.</p>
                        ...
                        <div class="item">
                            <div class="ast_testimonials_slider_box">
                                <img src="<?php echo base_url('asset/front/images/content/tm4.jpg')?>" alt="Testimonial">
                                <div class="ast_testimonials_slider_box_text">
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or less normal distribution.</p>
