...
<!--WhyWe Us End-->
<!--WeDo Start-->
<div class="ast_wedo_wrapper ast_toppadder70 ast_bottompadder50 horoscope">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1 col-xs-offset-0">
                <div class="ast_heading">
                    <h1>Your <span>horoscope</span></h1>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected hummer.</p>
                </div>
            </div>
            ...
            <div class="col-xs-12">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">Daliy Horoscope</a></li>
                    <li><a data-toggle="tab" href="#menu1">Weekly Horoscope</a></li>
                    <li><a data-toggle="tab" href="#menu2">Monthly horoscope</a></li>
                    <li><a data-toggle="tab" href="#menu3">Yearly Horoscope</a></li>
                </ul>
            </div>
...
<!--WeDo End-->
<!--Team Start-->
<div class="ast_team_wrapper ast_toppadder70 ast_bottompadder50 form-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1 col-xs-offset-0">
                <div class="ast_heading">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 male-birth">
                <div class="panel panel-default">
                    <div class="panel-heading">Male Birth Details</div>
            ...
            <div class="col-xs-12 col-sm-6 female-birth">
                <div class="panel panel-default">
                    <div class="panel-heading">Female Birth Details</div>
                    <div class="panel-body">
                        <form class="">
                            <div class="col-xs-12 form-group">
                                <label>Name</label>
